...
define("stratus.views.plugins.addclass", ["stratus", "jquery", "stratus.views.plugins.base"], function (Stratus, $) {
        ...
        initialize: function (options) {
            ...
            if (this.target) {
                if (_.contains(event, 'hover')) {
                    this.$el.hover(
                        function() { this.show.apply(this, arguments); }.bind(this),
                        function() { this.hide.apply(this, arguments); }.bind(this)
                    );
                }
                if (_.contains(event, 'click')) {
                    this.$el.on('click', function() { this.toggle.apply(this, arguments); }.bind(this));
                }
            }
        },
