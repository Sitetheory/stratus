  ...
  if (container.requirement.length) {
    ...
    require(container.requirement, function () {
      ...
      if (!_.contains(cssLoaded, 'angular-material.css')) {
        css.push(
          Stratus.BaseUrl + 'before/' + Stratus.RelativePath + 'bower_components/angular-material/angular-material' + (Stratus.Environment.get('production') ? '.min' : '') + '.css'
        )
      }
      if (Stratus('[froala]').length || Stratus.Directives.Froala) {
        [
          Stratus.BaseUrl + 'sitetheorycore/css/sitetheory.codemirror.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/codemirror/lib/codemirror.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/froala_editor.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/froala_style.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/code_view.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/draggable.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/file.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/fullscreen.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/help.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/image.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/image_manager.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/quick_insert.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/special_characters.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/table.min.css',
          Stratus.BaseUrl + Stratus.RelativePath + 'bower_components/froala-wysiwyg-editor/css/plugins/video.min.css'
