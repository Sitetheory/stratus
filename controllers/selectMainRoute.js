    ...
    Stratus.Controllers.SelectMainRoute = [
        ...
        function ($scope, $mdDialog, $rootScope) {
            ...
            $scope.$watch('model.data', function (routings) {
                ...
                console.log($scope.model.changed)
                // console.log(scope.routing)
                // console.log($rootScope.$$childHead.data)
                // if (scope.id && (scope.routing === undefined || scope.routing === '')) {
                //     $rootScope.$$childHead.data.changed = true;
