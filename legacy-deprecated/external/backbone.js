...
(function (factory) {
  ...
  var onApi = function (events, name, callback, options) {
    if (callback) {
      ...
      var context = options.context; var ctx = options.ctx; var listening = options.listening
  ...
  var offApi = function (events, name, callback, options) {
    ...
    var i = 0; var listening
    var context = options.context; var listeners = options.listeners
  ...
  var triggerEvents = function (events, args) {
    var ev; var i = -1; var l = events.length; var a1 = args[0]; var a2 = args[1]; var a3 = args[2]
    switch (args.length) {
      case 0:
  ...
  _.extend(Model.prototype, Events, {
    ...
    // An object of changes since the last sync
    patch: null,
    ...
    set: function (key, val, options) {
      // TODO: @Optimize! Handle a global change set on each model that is wiped when sync occurs, based on this.changed = {}
      ...
      // Store the changes
      this.patch = _.extend(this.patch || {}, this.changed)
  ...
  _.extend(Router.prototype, Events, {
    ...
    _bindRoutes: function () {
      ...
      var route; var routes = _.keys(this.routes)
