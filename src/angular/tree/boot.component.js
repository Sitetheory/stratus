System.register(["@angular/core", "stratus", "lodash", "stratus.services.registry"], function (exports_1, context_1) {
    ...
    var core_1, Stratus, _, localDir, TreeBootComponent;
    ...
    return {
        ...
        execute: function () {
            ...
            TreeBootComponent = class TreeBootComponent {
                constructor() {
                    this.title = 's2-tree';
                    Stratus.Instances[_.uniqueId('s2_tree_boot_component_')] = this;
                }
            };
            TreeBootComponent = __decorate([
                core_1.Component({
                    selector: 's2-tree',
            ...
            exports_1("TreeBootComponent", TreeBootComponent);
        }
    };
});
