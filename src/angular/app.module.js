System.register(["@angular/common/http", "@angular/core", "@angular/forms", "@angular/material", "@angular/platform-browser", "@angular/platform-browser/animations", "@stratusjs/angular/material", "@stratusjs/angular/base/base.component", "@stratusjs/angular/selector/selector.component", "@stratusjs/angular/tree/tree.component", "@stratusjs/angular/tree/tree-dialog.component", "@stratusjs/angular/tree/tree-node.component", "ngx-quill", "lodash", "stratus"], function (exports_1, context_1) {
    "use strict";
