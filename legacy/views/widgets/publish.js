...
(function (root, factory) {
  ...
  Stratus.Views.Widgets.Publish = Stratus.Views.Widgets.Base.extend({
    ...
    template: _.template('<div class="custom-font-primary btn-group"> <div id="{{ elementId }}" class="btn btn-publish btn-publish-now"> <div class="btn-gradient-light"></div> <span class="publish-icon"><svg viewBox="0 0 50 50" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradient-{{ elementId }}"><stop class="stop1" stop-color="#666" offset="0%"></stop><stop class="stop2" stop-color="#666" offset="100%"></stop></linearGradient></defs><g id="{{ elementId }}" class="action-button" fill="url(#linearGradient-{{ elementId }})"><path d="M28,30.1375457 L32.6427791,30.1375457 L25.3213895,21.7702433 L18,30.1375457 L23,30.1375457 L23,35.1375457 L28,35.1375457 L28,30.1375457 Z M14.3930477,42.7642673 C14.0797205,42.7921292 13.7624003,42.8063635 13.4417034,42.8063635 C7.67490984,42.8063635 3,38.2036363 3,32.5258846 C3,26.9640464 7.48597806,22.4337866 13.0899051,22.2511307 C13.0898906,22.2434018 13.0898833,22.2356713 13.0898833,22.227939 C13.0898833,15.5505992 18.5029368,10.1375457 25.1802767,10.1375457 C31.8576166,10.1375457 37.2706701,15.5505992 37.2706701,22.227939 C37.2706701,22.2416148 37.2706473,22.2552852 37.270602,22.2689504 C42.7051812,22.629413 47,27.0838387 47,32.5258846 C47,38.0471916 42.5791658,42.5519003 37.0324293,42.7959538 L37.3056032,43.1375457 L14.2064766,43.1375457 L14.3930477,42.7642673 Z" id="publish-vector"></path><path d="M72.701859,34.2998948 L64.8351456,26.4521221 L68.6232901,22.6260961 L72.4998246,26.5026307 L81.300947,17.7015082 L85.3037531,21.7043143 L72.701859,34.2998948 Z M75,7 C65.0561207,7 57,15.0624342 57,25 C57,34.9375658 65.0624342,43 75,43 C84.9375658,43 93,34.9375658 93,25 C93,15.0624342 84.9438793,7 75,7 L75,7 Z" id="published-vector"></path><path d="M118.142857,12.7890403 L133.857143,12.7890403 L133.857143,17.5533347 C133.857143,21.0635219 131.076209,24.506013 127.632002,25.2192395 C127.632002,25.2192395 126.544646,25.5 126.027623,25.5 C125.492184,25.5 124.368303,25.2118984 124.368303,25.2118984 C120.930084,24.4923777 118.142857,21.0598417 118.142857,17.5533347 L118.142857,12.7890403 Z M133.857143,38.2109597 L118.142857,38.2109597 L118.142857,33.4466653 C118.142857,29.9364781 120.923791,26.493987 124.367998,25.7807605 C124.367998,25.7807605 125.455354,25.5 125.972377,25.5 C126.507816,25.5 127.631697,25.7881016 127.631697,25.7881016 C131.069916,26.5076223 133.857143,29.9401583 133.857143,33.4466653 L133.857143,38.2109597 Z M115,8 L137,8 L137,11.1818182 L115,11.1818182 L115,8 Z M115,39.8181818 L137,39.8181818 L137,43 L115,43 L115,39.8181818 Z" id="publish-delay-vector"></path><path d="M165.059798,13.3852128 C167.694968,11.4345426 170.955888,10.2810397 174.486223,10.2810397 C183.245172,10.2810397 190.345703,17.3815708 190.345703,26.1405198 C190.345703,34.8994689 183.245172,42 174.486223,42 C166.458301,42 159.823524,36.035238 158.771959,28.2957813 L164.133072,28.2957813 C165.128356,33.1015263 169.385478,36.7135066 174.486223,36.7135066 C180.325522,36.7135066 185.05921,31.9798192 185.05921,26.1405198 C185.05921,20.3012205 180.325522,15.5675331 174.486223,15.5675331 C172.41893,15.5675331 170.490212,16.1608437 168.86106,17.1864745 L173.534927,21.8603419 L160.451524,22.4833611 L161.074543,9.39995745 L165.059798,13.3852128 Z" id="unpublish-vector"></path></g></svg></span> <span class="publish-text">Publish</span> </div>{% if (options.more) { %}<div id="dropdownBtn-{{ elementId }}" class="dropdown-toggle btn btn-publish btn-publish-more" data-toggle="dropdown"><div class="btn-gradient-light"></div><span class="caret"></span></div><div class="dropdown-menu pull-right btn-publish-dropdown" aria-labelledby="dropdownBtn-{{ elementId }}"><div>{% if (options.dateTimePicker) { %}<div data-type="dateTime" data-inline="true" data-collapse="true" data-usecurrent="false" data-customvalue="{{ model[options.versionEntity] ? model[options.versionEntity].timePublish : 0 }}" data-style="widget"></div>{% } %} {% if (options.unpublish) { %}<div><span class="action btn-unpublish" data-action="unpublish">Unpublish this Version</span></div>{% } %} {% if (options.revisionHistory && model[options.versionEntity]) { %}<a class="btn-version-history" href="/Content/Versions/Edit?id={{ model.id }}&versionId={{ model[options.versionEntity].id }}">Revision History</a>{% } %}</div></div>{% } %}</div>'),
