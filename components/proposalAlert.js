(function (root, factory) {
  ...
  Stratus.Components.ProposalAlert = {
    ...
    controller: function ($scope, $window, $attrs, $sce, $compile, commonMethods) {
      // Initialize
      commonMethods.componentInitializer(this, $scope, $attrs, 'proposal_alert', true);
    ...
    templateUrl: Stratus.BaseUrl + 'sitetheorystratus/stratus/components/proposalAlert' + (Stratus.Environment.get('production') ? '.min' : '') + '.html'
  };
}));
