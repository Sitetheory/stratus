            ...
            $scope.$watch('collection.models', function (models) {
                _.each(models, function (model) {
                    if (model.exists('id') && model.exists('sentinel')) {
                        ...
                        sentinel.permissions(model.get('sentinel'));
