...
(function (root, factory) {
  ...
  Stratus.Components.Delete = {
    ...
    template: '<md-button ng-if="model.id" aria-label="Delete" id="{{ elementId }}" class="btn btn-delete" ng-click="setDelete()"><div class="btn-gradient-light"></div><md-icon class="delete-icon" md-svg-src="/Api/Resource?path=@SitetheoryCoreBundle:images/icons/actionButtons/delete.svg"></md-icon><span class="delete-text">Delete</span></md-button>'
  }
}))
