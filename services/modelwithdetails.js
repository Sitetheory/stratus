//     Stratus.Services.Modelwithdetails.js 1.0
...
(function (root, factory) {
    ...
    // This Modelwithdetails Service handles data binding for a single object with the $http Service
    Stratus.Services.modelwithdetails = ['$provide', function ($provide) {
        $provide.factory('modelwithdetails', ['$q', '$http', '$rootScope', function ($q, $http, $rootScope) {
