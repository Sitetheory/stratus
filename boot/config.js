...
requirejs.config({
    ...
    paths: {
        ...
        'stratus.components.filter': bundle + 'stratus/components/filter' + suffix,
        ...
        'stratus.components.search': bundle + 'stratus/components/search' + suffix,
        'stratus.components.sort': bundle + 'stratus/components/sort' + suffix,
