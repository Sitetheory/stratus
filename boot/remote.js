// TODO: this is meant to be a file to do all the necessary boot loading in the simplest smallest way possible when loading a component remotely. The code below is for reference, but needs to be updated for new system.
