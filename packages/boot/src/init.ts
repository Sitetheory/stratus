...
((root: any) => {
    ...
    const appendJS = (paths: LooseObject) => {
    ...
    if (typeof requirejs !== 'undefined') {
        ...
        const constants: LooseObject = {}
        const wildcards: LooseObject = {}
        const dynamicModuleResolution = (id: string) => {
            if (typeof id !== 'string') {
                return false
            }
        ...
        System.constructor.prototype.resolve = function (id: string) {
            try {
